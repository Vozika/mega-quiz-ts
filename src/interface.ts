...
export const interfaceEN: Language = {
  ...
  HIDE_LETTERS_DESC:
    "Some like it hot. You see only the first and the last letter.",
...
export const interfaceRU: Language = {
  ...
  HIDE_LETTERS_DESC:
    "Для любителей трудностей. Видны только первая и последняя буквы ответа.",
